...
<div class="pt-20 min-h-screen bg-gradient-to-b from-[#E5F2E1] to-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <?php
    // Ambil berita terbaru (headline)
    $headline_query = "SELECT * FROM berita ORDER BY tanggal DESC LIMIT 1";
    $headline_result = mysqli_query($koneksi, $headline_query);
    ...
    <?php if ($headline): ?>
      ...
      <div class="grid lg:grid-cols-2 gap-8 mb-16">
        ...
        <div class="flex flex-col justify-center bg-white p-8 rounded-3xl shadow-xl border-4 border-[#5F8D4E]">
          ...
          <p class="text-gray-600 mb-4"><?= substr(strip_tags($headline['isi']), 0, 150) ?>...</p>
    ...
    <div class="grid md:grid-cols-3 gap-8 mb-12">
      <?php
      // Ambil semua berita selain headline
      $news_query = "SELECT * FROM berita ORDER BY tanggal DESC LIMIT 9 OFFSET 1";
