    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <a href="berita.php" class="inline-block bg-secondary text-light px-10 py-4 rounded-lg font-semibold hover:bg-primary hover:scale-105 transition-all duration-300 shadow-lg">
            Lihat Selengkapnya
          </a>
        </div>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <a href="edukasi.php" class="inline-block bg-primary text-light px-10 py-4 rounded-lg font-semibold hover:bg-secondary hover:scale-105 transition-all duration-300 shadow-lg">
            Lihat Selengkapnya
          </a>
        </div>
