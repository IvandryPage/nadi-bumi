...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Nov 2025 pada 16.43
...
CREATE TABLE `berita` (
  `idBerita` varchar(5) NOT NULL,
  `judul` text NOT NULL,
  `gambar` text NOT NULL,
  `isi` text NOT NULL,
  `tanggal` date NOT NULL,
  `idAdmin` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `glosarium` (
  `idGlosarium` varchar(5) NOT NULL,
